...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
			<h3 class="page-title">Promo Code Generate</h3>
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box orange">
						<div class="portlet-title">
							<div class="caption">
								<span class="caption-subject">List of Promo Code Generate </span>
							</div>
							<div class="actions">
								<a href="<?php echo site_url('promo_code_generate/create'); ?>" class="btn btn-default btn-sm blue-stripe">
									<i class="fa fa-plus"></i>
									Add New Promo Code Generate
								</a>
							</div>
						</div>
						<div class="portlet-body">
                            ...
                            <table id="table_grid" class="table table-condensed table-striped table-hover" style="width:1500px !important">
                                <thead>
                                    <tr>
                                        <th width="20"><input type="checkbox" name="checkAll" value=""></th>
