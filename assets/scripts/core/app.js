...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        $('.page-sidebar-menu li a[href="'+current_url+'"]').parent().addClass('active');
        $('.page-sidebar-menu li a[href="'+current_url+'"]').append('<span class="selected"></span>');
        $('.page-sidebar-menu ul.sub-menu li a[href="'+current_url+'"]').parent().parent().parent().addClass('active');
        $('.page-sidebar-menu ul.sub-menu li a[href="'+current_url+'"]').parent().parent().siblings('a').append('<span class="selected"></span>');
    }
